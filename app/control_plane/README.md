...
- `releases.olopa.io` serves static artifacts from `app/control_plane/releases` (`/` -> `/latest/index.html`)
- `releases.olopa.io/latest/install.sh` is routed to the live `/install.sh` endpoint
